...
struct GenerateCommand: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        abstract: "Generate code from a validated model and persist it to disk."
    )
    ...
    @Option(name: .long, help: "Optional output directory. Defaults to '<basePath>/modelhike-output'.")
    var output: String?
